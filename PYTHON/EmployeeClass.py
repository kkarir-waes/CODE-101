...
luigi2 = DirectDeveloper("Luigi 2 Vercotti", 30, "php")
print(luigi2.get_details())
print(luigi2.calculate_holidays(luigi.no_of_years))
print(f'${luigi2.calculate_salary()}')
